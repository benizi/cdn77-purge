...
(mwm/defn remove-between [page start-text end-text]
...
(mwm/defn keep-body [page]
  (.substring page (.indexOf page "<body")))

(mwm/defn remove-wordfence [page]
  (-> page
      (keep-body)
